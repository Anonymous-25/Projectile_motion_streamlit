...
st.set_page_config(
    ...
    page_icon="https://cdn-icons-png.flaticon.com/128/19037/19037525.png",
    layout="wide"
)
fa_css = '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">'
...
st.title(":green[Projectile Motion Simulator]")
